...
class GroupCreateActivity : AppCompatActivity() {
    ...
    private fun startCreatingGroup() {
        ...
        if (image_uri == null) {
            ...
            //upload image
            //image name and path
            val fileNameAndPath = "Group_Imgs/image$tournamentId"
    ...
    private fun createGroup(
        ...
        ref.child(tournamentId).setValue(hashMap)
            .addOnSuccessListener {
                ...
                hashMap1["timestamp"] = tournamentId
                hashMap1["yourName"] = "" + tournamentId
                hashMap1["phoneNumber"] = "" + tournamentId
                val ref1 = FirebaseDatabase.getInstance().getReference("Tournament").child("Groups")
                ref1.child(tournamentId).child("Participants").child(firebaseAuth!!.uid!!)
                    .setValue(hashMap1)
