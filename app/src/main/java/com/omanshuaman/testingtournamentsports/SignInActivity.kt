...
import com.omanshuaman.testingtournamentsports.databinding.ActivitySignInBinding
...
class SignInActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            .requestIdToken("733472858792-6caldi00ppb5e7525oumrrit258pv3bp.apps.googleusercontent.com")
            .requestEmail()
            .build()
